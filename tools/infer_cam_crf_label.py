...
parser.add_argument("--root_dir", default='./VOC2012', type=str, help="root_dir")
...
parser.add_argument("--cam_path", default='./cam', type=str, help="logit")
parser.add_argument("--dst_dir", default='./cam/cam_label_crf_baseline_arm', type=str, help="dst")
...
def crf_proc(args):
    ...
    # args.dst_dir = args.cam_path.join(cam_path, args.dst_dir)
