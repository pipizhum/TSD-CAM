...
parser.add_argument("--model_path", default="./baseline.pth", type=str, help="model_path")
# parser.add_argument("--model_path", default="./baseline.pth", type=str, help="model_path")
...
parser.add_argument("--base_dir", default='./cam/cam_picture', type=str, help="train/val/test list file")
...
def _validate(model=None, data_loader=None, args=None):
    ...
    cam_dir = os.path.join(base_dir, "cam_img_baseline1", args.infer_set)
