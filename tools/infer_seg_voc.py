...
# parser.add_argument("--model_path", default="workdir_voc_final2/2022-11-04-01-50-48-441426/checkpoints/best.pth", type=str, help="model_path")
# parser.add_argument("--model_path", default="./toco_deit-b_voc_20k.pth", type=str, help="model_path")
parser.add_argument("--model_path", default="./model_iter_6000.pth", type=str, help="model_path")
parser.add_argument("--base_dir", default="./drf", type=str, help="model_path")
    ...
    with torch.no_grad(), torch.cuda.device(0):
        ...
        for idx, data in tqdm(enumerate(data_loader), total=len(data_loader), ncols=100, ascii=" >="):
            ...
            for sc in args.scales:
                ...
                # _inputs = F.interpolate(img2, size=[_h, _w], mode='bilinear', align_corners=False)
...
if __name__ == "__main__":
    ...
    args.logits_dir = os.path.join(base_dir, "segs_baseline_arm_sd/logits", args.infer_set)
    args.segs_dir = os.path.join(base_dir, "segs_baseline_arm_sd/seg_preds", args.infer_set)
    args.segs_rgb_dir = os.path.join(base_dir, "segs_baseline_arm_sd/seg_preds_rgb", args.infer_set)
