...
parser.add_argument("--model_path", default="./baseline_arm.pth", type=str, help="model_path")
...
parser.add_argument("--base_dir", default='./cam', type=str, help="base dir")
...
def validate():
    ...
    _validate(args.local_rank, model=model, dataset=val_dataset, args=args)
